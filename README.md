...
Пользователь скачивает приложение, регистрируется, проходит небольшой онбординг и попадает на основную страницу — личный кабинет. 
После этого пользователю предлагается пополнить брокерский счёт. Пополнение брокерского счёта называется совершением депозита (не путать с банковским вкладом). Первое пополнение брокерского счёта — это первый депозит, второе пополнение — второй депозит, и так далее.
Пользователь может покупать активы разной степени риска: 
- низкорискованные,
- среднерискованные,
- высокорискованные.
Приток новых пользователей стабильный — около 700 установок в день. Но команда заметила, что после регистрации и первого пополнения депозита многие не покупают активы, а те, кто уже купил, не открывают повторные депозиты. Ключевые метрики продукта не растут. 
